...
var verticesCount = 0, edgesCount = 0, trianglesCount = 0;
 ...
 */
var Triangle = function (vertices, edges, neighbours) {
...
Triangle.prototype.circumcircleContains = function (v) {
	// The vertex is inside of the circumcircle if its distance to the circle's center is less than or equal to the circle's radius.
